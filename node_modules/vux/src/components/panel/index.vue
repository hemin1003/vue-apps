<template>
  <div class="weui_panel weui_panel_access">
    ...
    <div class="weui_panel_bd">
      ...
      <!--type==='2'-->
      <div v-if="type === '2'">
        <div class="weui_media_box weui_media_text" v-for="item in list" @click.prevent="onItemClick(item)">
            <h4 class="weui_media_title">{{item.title}}</h4>
            <p class="weui_media_desc">{{item.desc}}</p>
        </div> 
      </div>
      ...
      <div class="weui_media_box weui_media_small_appmsg">
          <div class="weui_cells weui_cells_access"  v-if="type === '3'">
            <a class="weui_cell" :href="getUrl(item.url)" v-for="item in list" @click.prevent="onItemClick(item)">
